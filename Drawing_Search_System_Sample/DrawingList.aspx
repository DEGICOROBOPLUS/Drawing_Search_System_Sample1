...
<body>
    <form id="form1" runat="server">
        ...
        <asp:RadioButtonList ID="RadioButtonList1" RepeatDirection="Horizontal" RepeatColumns="3" runat="server" style="z-index: 1; left: 354px; top: 97px; position: absolute; height: 27px; width: 380px">
        ...
        <div style="margin-left: 240px; z-index: 1; left: -40px; top: 4px; position: absolute; height: 83px; width: 1016px;">
            ...
            <asp:Table ID="Table2" runat="server" Height="16px" Width="1004px" GridLines="Both">
                ...
                <asp:TableRow runat="server">
                    ...
                    <asp:TableCell runat="server">ネジ</asp:TableCell>
                    <asp:TableCell runat="server">ネジ図面.pdf</asp:TableCell>
                    <asp:TableCell runat="server"></asp:TableCell>
                    <asp:TableCell runat="server">pdf</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow runat="server">
