...
<body style="height: 320px; z-index: 1; left: 0px; top: 0px; position: absolute; width: 1465px">
    <form id="form1" runat="server">
        ...
        <p style="margin-left: 560px; height: 80px; width: 201px; z-index: 1; left: 23px; top: 17px; position: absolute;">
            <asp:Label ID="Label3" runat="server" Text="図面検索" Font-Size="XX-Large" style="z-index: 1; left: 23px; top: 19px; position: absolute; height: 47px; width: 158px"></asp:Label>
        </p>
        </div>
        <p style="margin-left: 520px; width: 1172px; z-index: 1; left: -395px; top: 56px; position: absolute; height: 250px; margin-top: 10px;">
            ...
            <asp:Label ID="Label1" runat="server" Text="企業ID" style="z-index: 1; left: 226px; top: 123px; position: absolute; width: 50px"></asp:Label>
        ...
        <p style="margin-left: 280px">
            <asp:Label ID="Label2" runat="server" Text="パスワード" style="z-index: 1; left: 711px; top: 189px; position: absolute"></asp:Label>
        </p>
    </form>
</body>
</html>
